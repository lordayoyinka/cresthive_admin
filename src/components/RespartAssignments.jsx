...
const RespartAssignments = () => {
  return (
    <div>
     <div className="mb-5 bg-white p-6 rounded-lg ">
        <h2 className="font-semibold text-lg pb-4 opacity-50">Assignments</h2>
        ...
        >
          {people.map((person) => (
            ...
            >
              <div className="flex-1 gap-auto flex flex-col p-2 ">
        ...
        <h2 className="font-semibold flex justify-end text-blue-900 text-xs pt-4 opacity-90"><a href='/ResAssignments'>See more</a></h2>
...
export default RespartAssignments