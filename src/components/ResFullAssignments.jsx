...
const ResFullAssignments = () => {
  return (
    <div>
     <div className="mb-5 bg-white p-6 rounded-lg ">
        <h2 className="font-semibold text-lg pb-4 opacity-50">All Assignments</h2>

        <ul
          role="list"
          className="grid gap-auto grid-cols-2 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5"
        >
          {people.map((person) => (
            <li
              key={person.email}
              className="w-3/4  m-2 justify-self-start p-2 align-self-start flex-1 text-start bg-gray-50 rounded-lg shadow  "
            >
...
export default ResFullAssignments